...
{"jsonrpc":"2.0","id":1,"result":{"protocolVersion":"2025-03-26","serverInfo":{"name":"CodeGraphContext","version":"0.4.4"},"capabilities":{"tools":{"listTools":true}}}}
...
```
CodeGraphContext/
├── pyproject.toml                    # Package metadata, deps, scripts (v0.4.4)
